...
#
# Generated by Vivado on Mon Apr 12 15:32:28 -0700 2021
...
xv_boost_lib_path=C:/software/Xilinx/Vivado/2020.2/tps/boost_1_64_0
xvlog_opts="--relax"


# Script info
echo -e "output_fifo.sh - Script generated by export_simulation (Vivado v2020.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot output_fifo xil_defaultlib.output_fifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim output_fifo -key {Behavioral:sim_1:Functional:output_fifo} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="C:/software/Xilinx/Vivado/2020.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
